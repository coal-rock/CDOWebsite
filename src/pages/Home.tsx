...
export default function Home() {
    ...
    const featuresData = [
        {
            title: "Workshops",
            description: "We hold weekly workshops during the semester to teach members new security skills.",
            linkText: "SEE WHAT'S HAPPENING",
            linkUrl: "/",
            icon: (
                <svg width='80' height='80' viewBox='0 0 24 24' fill='currentColor' className='text-white shrink-0'>
    ...
    return (
        <>
            <Header/>
            <div className='flex flex-col w-full items-start bg-gray-950'>
