                ...
                <div className='mx-auto max-w-9xl px-2 sm:px-4 lg:px-6'>
                    <div className='relative flex h-12 md:h-16 items-center justify-between'>
                        ...
                        <div className='flex-row hidden lg:flex'>
                            {routes.map((route) => (
                                <Link
                                    className='flex flex-row text-xl text-gray-300 font-mono p-2 hover:text-white transition-colors duration-200'
                                    to={route[1]}>
                        ...
                        >
                            <div className='flex-row lg:flex'>
                                {routes.map((route) => (
                                    <Link
                                        className='flex flex-row text-gray-300 font-mono p-2 hover:text-white transition-colors duration-200'
                                        to={route[1]}>
                                        <p className='text-indigo-400'>
                                            {"/ "}
                                        </p>
